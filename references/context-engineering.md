...
- **No flat task scripting; re-derive at task entry** — philosophy P2; `leanplan.md` §1.3 → [[jit-loading]], [[distractor-sensitivity]], [[context-rot]]. A frozen step-by-step script rots against current code into a stale distractor; re-deriving JIT-loads current reality.
