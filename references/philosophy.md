...
3. **Small surface for review.** Verbose artifacts get rubber-stamped, leak over-specific instructions to implementation, and degrade agent reasoning. Keep surface artifacts terse; archive elsewhere.
