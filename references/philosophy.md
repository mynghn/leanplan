...
REQUIREMENT (World WHAT) → SPEC (Machine contract, generic categories only) → DESIGN (chosen realization) → TASK (`plan.md` work cards) → code. Archive companions: DESIGN RATIONALE (WHY behind decisions), RESEARCH (evidence behind WHY).
