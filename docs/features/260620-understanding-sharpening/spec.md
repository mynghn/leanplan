...
### O-1: sharpen-invocable-mid-any-stage
...
### O-3: injected-claim-verified-not-obeyed
...
### O-4: understanding-delta-emitted
...
### INV-1: no-auto-mutation-of-committed-artifacts
The move performs no edits to any committed artifact. Even when its delta implies a committed artifact is now wrong, the move surfaces that implication (O-4) and stops without editing.

### INV-2: in-flight-stage-preserved
...
### INV-4: understanding-delta-durable
