...
### O-1: load-bearing-rule-names-its-principle
...
### O-2: principle-resolves-to-grounded-definition
...
### O-3: framework-conforms-to-its-own-advice
...
### INV-2: provenance-is-dated-and-visible
...
### INV-3: grounding-stays-off-the-hot-path
...
- A use-time dependency on any external knowledge base is excluded outright (see `INV-1`), including an optional one.
