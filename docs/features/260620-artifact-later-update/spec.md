...
### O-1: update-invocable-from-any-in-flight-stage
...
### O-2: change-propagated-downstream
...
### INV-2: committed-set-stays-consistent
...
### INV-3: change-stays-downstream-only
...
- **Detecting or adjudicating the drift.** This contract takes the drift and its justification as input (INV-1); it neither discovers drift nor judges whether the understanding truly moved. Surfacing drift is independent detection (#15); deciding it moved is understanding-sharpening (#8).
