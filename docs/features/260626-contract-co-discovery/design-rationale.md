...
Chosen: an opt-in probe inside Specify, structurally mirroring Requirements' Elicit/Frame/Surface but at the contract altitude, feeding dialogue/research with only accepted items reaching the surface.
