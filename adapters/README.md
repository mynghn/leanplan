...
|---|---|---|---|---|---|---|
| `requirements` | `references/requirements.md` | `adapters/claude/leanplan-requirements/SKILL.md` | `adapters/codex/leanplan-requirements/SKILL.md` | Writes `docs/features/<KEY>/requirements.md` after allocator-created feature dir | Claude `/leanplan-specify <KEY>`; Codex `leanplan-specify <KEY>` | Skill name matches across vendors; semantics match. |
...
| `sharpen` | `references/sharpen.md` | `adapters/claude/leanplan-sharpen/SKILL.md` | `adapters/codex/leanplan-sharpen/SKILL.md` | Appends `docs/features/<KEY>/understanding-shifts.md`; reads but never edits surface artifacts | Return to interrupted move | Skill name matches across vendors; semantics match. |
