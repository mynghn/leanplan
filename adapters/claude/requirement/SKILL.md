---
name: requirement
description: LeanPlan — author a REQUIREMENT artifact for a feature. Interactive extraction of a feature's Problem + Outcome (no implementation choices); standalone edge.
