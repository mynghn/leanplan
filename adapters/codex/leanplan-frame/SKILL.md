---
name: leanplan-frame
description: LeanPlan — author a Requirements artifact for a feature in Codex. Use for `leanplan-frame <intent>` or when asked to run the LeanPlan Requirements stage.
---
